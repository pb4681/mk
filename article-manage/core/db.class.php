...
class mysql {
    ...
    public function __construct() {
        $data_cfg = require dirname(__FILE__).'/../config/database.php';
        $this->db_host = $data_cfg['host'];
        $this->db_user = $data_cfg['user'];
        $this->db_pwd = $data_cfg['pwd'];
        $this->db_database = $data_cfg['database'];
        $this->conn = $data_cfg['conn'];
        $this->coding = $data_cfg['coding'];
        $this->connect();
    }
